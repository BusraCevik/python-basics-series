# Password Generator
# This script generates a secure password based on user preferences:
# minimum length, inclusion of digits, and special characters.
# It ensures the generated password meets all selected criteria.
